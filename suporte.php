...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $assunto = trim($_POST['assunto'] ?? 'Suporte - ProjectClone');
    ...
    if (!empty($nome) && !empty($email) && !empty($mensagem)) {
        ...
        $to = 'contato@4u.ia.br';
        $subject = 'Suporte ProjectClone: ' . $assunto;
...
<head>
  ...
  <title>Central de Suporte & FAQ — ProjectClone (4U.IA.BR)</title>
  <meta name="description" content="Central de Ajuda, Suporte e Perguntas Frequentes do ProjectClone. Tire suas dúvidas sobre cronogramas e gráficos de Gantt.">
...
<body>
  ...
  <footer>
    &copy; <?php echo date('Y'); ?> 4U.IA.BR &bull; ProjectClone &bull; Atendimento e Suporte.
  </footer>
