...
<head>
  ...
  <title>Política de Privacidade & LGPD — ProjectClone (4U.IA.BR)</title>
  <meta name="description" content="Política de Privacidade e conformidade LGPD do ProjectClone. Processamento local, privacidade por design e segurança de dados.">
...
<body>
  ...
  <main style="flex:1; padding: 0 20px;">
    <div class="legal-container">
      ...
      <p>O <strong>ProjectClone</strong> foi desenvolvido em total conformidade com a Lei Geral de Proteção de Dados (Lei nº 13.709/2018 - LGPD). Seus cronogramas corporativos e dados de projetos não são monitorados nem enviados para servidores externos.</p>
