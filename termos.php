...
<head>
  ...
  <title>Termos de Uso — ProjectClone (4U.IA.BR)</title>
  <meta name="description" content="Termos de Uso do ProjectClone. Condições de uso para gestão de projetos, cronogramas e gráficos de Gantt.">
...
<body>
  ...
  <nav class="navbar">
    <a href="index.html" class="back-btn">
      <i class="fas fa-arrow-left"></i> Voltar ao ProjectClone
    </a>
    <a href="index.html" class="brand-logo">
      <div class="brand-icon"><i class="fas fa-chart-gantt"></i></div>
      <span>ProjectClone <span style="color:#10b981;">365</span></span>
    </a>
  </nav>
  ...
  <main style="flex:1; padding: 0 20px;">
    <div class="legal-container">
      ...
      <p>O <strong>ProjectClone</strong> é uma suíte profissional de gerenciamento de projetos, cronogramas, gráficos de Gantt e quadros Kanban, projetada para planejamento, acompanhamento de tarefas, alocação de recursos e análise de caminho crítico.</p>
      ...
      <p>O ProjectClone é fornecido como ferramenta de planejamento e produtividade. As decisões de gestão, prazos e custos executados em projetos reais são de total responsabilidade dos seus gestores.</p>
    </div>
  </main>

  <footer>
    &copy; <?php echo date('Y'); ?> 4U.IA.BR &bull; ProjectClone &bull; Todos os direitos reservados.
  </footer>
